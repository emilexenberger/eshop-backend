...
3. **Configure application properties**:
   - Update `application.properties` with your MySQL credentials (username, password, and database name) or use default values: "eshop_username" and "eshop_password"


4. **Run the application**:
    - Run the EshopApplication.java in your IDE.
